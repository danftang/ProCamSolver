...
//
///////////////////////////////////////////////////////////////////////////////
#ifndef STRUMTRIGGSSOLVER_H
#define STRUMTRIGGSSOLVER_H
...
///////////////////////////////////////////////////////////////////////////////
/// Implementation of the algorithm described in Strum and Triggs
...
///////////////////////////////////////////////////////////////////////////////
template<int M>
class StrumTriggsSolver {
public:
  StrumTriggsSolver(MotionMatrix<M> &, ShapeMatrix &);
